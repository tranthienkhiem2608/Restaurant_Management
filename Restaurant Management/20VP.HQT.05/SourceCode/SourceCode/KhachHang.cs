...
namespace SourceCode
{
    public partial class KhachHang : Form
    {
        ...
        {
            string sqlselect1 = "SELECT MASP as N'Mã sản phẩm', MADT as N'Mã đối tác', TENSP as N'Tên SP', SLTON as N'Số lượng tồn', DONGIA as N'Đơn giá', MATD as N'Mã thực đơn' FROM SANPHAM";
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            if (count == 2)
            {
                ...
                string sqlselect1 = "EXEC SP_INSERT_DH '" + temp + "', N'Đang xử lý', @DC ," + 0 + ", " + 0 + ", @NGAY_DH";
                SqlCommand cmd1 = new SqlCommand(sqlselect1, connect);
                cmd1.Parameters.Add(new SqlParameter("@DC", textBox1.Text));
                cmd1.Parameters.Add(new SqlParameter("@NGAY_DH", now));
